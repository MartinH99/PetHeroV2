            ...
            ?>
                <div class="col-md-4">
                    <div class="card bg-light m-5 border-start ">
                        ...
                        <div class="card-body">
                            <a href="#" class="card-link">Patea a x</a><!--Algun lugar q sirva como info del user o de la pet -->
                            <a href="#" class="card-link">Patea a y</a><!--Algun lugar q sirva como info del user o de la pet -->
                        </div>
                    </div>
